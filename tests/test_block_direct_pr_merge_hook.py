...
@pytest.mark.parametrize(
    ...
    [
        ...
        "gh api repos/o/r/pulls/9/merge",
        "gh api -X PUT repos/o/r/pulls/9/merge",
        "gh api --method PUT repos/o/r/pulls/9/merge",
        "gh api -XPUT repos/o/r/pulls/9/merge",
        "gh api -X GET --method PUT repos/o/r/pulls/9/merge",
        "gh api repos/o/r/pulls/9/merge -f body='see -X GET docs'",
        "gh --repo o/r api -X PUT repos/o/r/pulls/9/merge",
        "gh api graphql -f query='mutation { mergePullRequest(input: {}) }'",
        "gh api -X GET repos/o/r/pulls/9 ; gh pr merge 9",
        "gh api -X GET a && gh api -X PUT repos/o/r/pulls/9/merge",
        "gh pr merge 9 --body 'see -X GET docs'",
    ],
)
...
@pytest.mark.parametrize(
    ...
    [
        ...
        "gh api -X GET repos/o/r/pulls/9/merge",
        "gh api --method GET repos/o/r/pulls/9/merge",
        "git merge main",
        "echo hello",
        "",
    ],
